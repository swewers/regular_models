...
In this module we implement the algorithm described in Section 7 of our preprint
...
def lci(xi):
    ...
    B = K['U, T, x']
    (U, T, x,) = B._first_ngens(3)
    J = B.ideal(B(u) - U, B(t) - T)
    return [J.elimination_ideal([x]).gens()[0], u, t]
